...
void populateNeiArray(int num_of_life_cell, int sec_array[], int formula[], int main_grid[][20], int nei_array[], int &number_of_nei);
void secArrayLiveCount(int num_of_life_cell,int sec_array[], int formula[],int main_grid[][20], int live_nei_live_count[]);
void neiArrayLiveCount(int nei_array[],int number_of_nei, int formula[], int main_grid[][20], int nei_nei_live_count[], int num_of_life_cell,int sec_array[]);
...
void reInitializeArrays(int sec_Array[],int nei_array[],int nei_nei_live_count[],int live_nei_live_count[],int main_grid[][20]);
...
void start()
{
    ...
    do{
        ...
        cout<<endl<<"No of Generation : "<<gen_times<<endl;
        cout<<"<<Input>>*******************    Main Grid   ***********************************"<<endl<<endl;
        ...
        gridPopulate(main_grid, num_of_life_cells, sec_Array);
        cout<<"<<Output>>*******************    Main Grid   ***********************************"<<endl<<endl;
        displayGrid(main_grid);
        gen_times++;
...
void secArrayLiveCount(int num_of_life_cell,int sec_array[], int formula[],int main_grid[][Grid_columns], int live_nei_live_count[])
{
    ...
    for(int i = 0; i < num_of_life_cell*2; i+=2)
  {
      ...
      for(int j = 0; j < 8*2; j+=2)
      {
          ...
          for(int x = 0;i<num_of_life_cell*2; x+=2)
          {
